...
namespace Sanduba.Core.Domain.Customers
{
    ...
    {
        private const int registrationLength = 11;
        ...
        protected override string AddMask(string identityNumber)
        {
            return identityNumber.Trim().Replace(".", "").Replace("-", "");
        }
        ...
        public static bool Validate(string candidateIdentity)
        {
            ...
            tempCpf = identityNumberCandidate.Substring(0, 9);
            soma = 0;
            ...
            return identityNumberCandidate.EndsWith(digito);
        }
    }
}